...
for (let i = 0; i < 20; i++) {
    const maggot =  PIXI.Sprite.fromImage('./maggot.png');
...
const displacementSprite = PIXI.Sprite.fromImage('./displace.png');
...
const ring = PIXI.Sprite.fromImage('./ring.png');
ring.anchor.set(0.5);
ring.visible = false;
app.stage.addChild(ring);

const bg = PIXI.Sprite.fromImage('./bkg-grass.jpg');
